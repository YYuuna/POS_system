...
path('login/',views.UserLoginView.as_view(),name='login'),
    ...
    path('ventes/<int:pk>/modifier/', views.SaleUpdateView.as_view(), name='update-sale'),
    path('ventes/<int:pk>/supprimer/', views.SaleDeleteView.as_view(), name='delete-sale'),
    path('get_initial_selling_price/',views.GetInitialSellingPriceView.as_view(), name='get_initial_selling_price'),
